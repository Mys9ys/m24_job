...
<? 
// BEGIN Вывод UF_PRETITLE для раздела "Массажные кресла для дома" (КВ) 
				...
				<div class="catalog-item-info">							
					...
					<div class="item-all-title">
						<a class="item-title" href="<?=$arElement['DETAIL_PAGE_URL']?>" title="<?=$arElement['NAME']?>" itemprop="url">
							<span itemprop="name"><?=$pretitle?><?=$arElement['NAME']?></span>
						</a>
					</div>
                    <!--noindex-->
					...
					<div class="buy_more">
						<?if(isset($arElement["OFFERS"]) && !empty($arElement["OFFERS"])):?>
							<div class="available" itemscope itemtype="http://schema.org/Offer" itemprop="offers">
