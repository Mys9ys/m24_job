		...
		<div class="cart-items">
			<div class="equipment-order list">
				<div class="thead">
					...
					<div class="cart-item-date"><?=GetMessage("STPOL_ORDER_DATE")?></div>
					...
					<?foreach($arResult["ORDERS"] as $key => $val):?>
						<div class="tr">
							<div class="tr_into">
									...
									<div class="cart-item-plus-minus">
										<script type="text/javascript">
											$(document).ready(function() {
												$("#plus-minus-<?=$val['ORDER']['ACCOUNT_NUMBER']?>").click(function() {
													var clickitem = $(this);
													...
													$(".cart-items.basket.<?=$val['ORDER']['ACCOUNT_NUMBER']?>, .order-recipient.<?=$val['ORDER']['ACCOUNT_NUMBER']?>, .order-item-actions.<?=$val['ORDER']['ACCOUNT_NUMBER']?>").slideToggle();
												});
											});
										</script>
										<a href="javascript:void(0)" id="plus-minus-<?=$val['ORDER']['ACCOUNT_NUMBER']?>" class="plus"><i class="fa fa-plus-circle"></i><i class="fa fa-minus-circle"></i></a>
									</div>
								...
								<div class="cart-items basket <?=$val['ORDER']['ACCOUNT_NUMBER']?>" style="display:none;">
								...
								<table class="order-recipient <?=$val['ORDER']['ACCOUNT_NUMBER']?>" style="display:none;">
								...
								<div class="order-item-actions <?=$val['ORDER']['ACCOUNT_NUMBER']?>" style="display:none;">
