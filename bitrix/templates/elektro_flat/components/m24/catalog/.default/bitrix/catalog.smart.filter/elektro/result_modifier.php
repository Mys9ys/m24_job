...
$arFilter = makeFilter($arParams["IBLOCK_ID"], $arParams["SECTION_ID"], (string)$arParams["FILTER_NAME"], $arParams['HIDE_NOT_AVAILABLE']);
$arResult["ELEMENT_COUNT_NOT_AJAX"] = CIBlockElement::GetList(array(), $arFilter, array(), false);
