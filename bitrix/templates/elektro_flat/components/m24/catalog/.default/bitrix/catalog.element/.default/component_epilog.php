...
GLOBAL $lastModified;
if (!$lastModified) $lastModified = MakeTimeStamp($arResult['TIMESTAMP_X']);
else $lastModified = max($lastModified, MakeTimeStamp($arResult['TIMESTAMP_X']));
...
// канонические ссылки
$APPLICATION->AddHeadString('<link href="//'.$_SERVER['SERVER_NAME'].$arResult['DETAIL_PAGE_URL'].'" rel="canonical" />',true);
