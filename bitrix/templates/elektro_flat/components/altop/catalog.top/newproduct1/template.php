								...
								<div class="available">
									<?if($arItem["OFFERS_MIN_PRICE"]["CAN_BUY"]):?>
										<div class="avl">
											...
											<span><?=GetMessage("CATALOG_ELEMENT_AVAILABLE")/*." ".$arItem["OFFERS_MIN_PRICE"]["CATALOG_QUANTITY"]*/?></span>
										</div>
							...
							<?else:?>
								<div class="available">
									<?if($arItem["CAN_BUY"]):?>
										<div class="avl">
											<i class="fa fa-check-circle"></i>
											<span><?=GetMessage("CATALOG_ELEMENT_AVAILABLE")/*." ".$arItem["CATALOG_QUANTITY"]*/?></span>
										</div>
