...
<? $APPLICATION->SetAdditionalCSS('/bitrix/components/mainpage/basket2/style.css'); ?>
                    ...
                    <div class="basket_products_block">
                        <?foreach($arResult['BASKET_ITEMS'] as $product){?>
                            <div class="basket_products_item cl_items_prop"
                                ...
                                <div class="product_name_wrap"><a class="product_name" href="<?=$product['DETAIL_PAGE_URL']?>"><?=$product['name']?></a></div>
                ...
                <div class="basket_slide_contacts owlElement">
                    <div class="contacts_block block_minimum">
                        ...
                        <div class="input_wrap">
                            ...
                            <input class="form_input_basket validate_basket input_basket phonenumber" data-name="phone" type="text" value="<?=$_COOKIE['basket_phone']?>" id="ORDER_PROP_3" placeholder="Телефон*">
                ...
                <div class="basket_slide_contacts owlElement">
                    <div class="contacts_block block_minimum">
                        ...
                        <div class="input_wrap">
                            ...
                            <input class="form_input_basket fullname_input input_basket" data-name="fullname" type="text" id="bskt_name" value="<?=$_COOKIE['basket_fullname']?>" placeholder="Ф.И.О.*">
                        </div>
                        <div class="input_wrap">
                            <span class="input_placeholder"><?if(!empty($_COOKIE['basket_email'])) echo 'E-Mail'?></span>
                            <input class="form_input_basket email_input input_basket" data-name="email" type="text" id="ORDER_PROP_2" value="<?=$_COOKIE['basket_email']?>" placeholder="E-Mail (необязательно)">
                        </div>
                    ...
                    <div class="delivery_block block_minimum">
                        ...
                        <div class="delivery_box">
                            <?foreach ($arResult['DELIVERY'] as $key => $delivery){?>
                                <div class="delivery_item" data-delivery="<?=$delivery['ID']?>" id="delivery_id_<?=$delivery['ID']?>" data-paysystem="<?=$arResult['DELIVERY_NEW'][$delivery['ID']]?>">
                                    <div class="check_delivery_item">
                                        <div class="check_elem_delivery <?if($key == 0) {echo 'delivery_check_elem_active'; $cheked =$delivery['ID']; $paysystem_check = $arResult['DELIVERY_NEW'][$delivery['ID']];}?>">
                                        </div>
                                    </div>
                            ...
                            <div class="delivery_adress_block">
                                <div class="input_wrap">
                                    ...
                                    <input class="form_input_basket adress_input input_basket" data-name="adress" type="text" id="bskt_adress" value="<?=$_COOKIE['basket_adress']?>" placeholder="Адрес*">
                                </div>
                            </div>
                        </div>
                        <div class="prev_slide basket_btn btn_left" data-slide="3">Назад</div>
                        <div class="delivery_confirm basket_btn btn_right" data-delivery="<?=$cheked?>" data-paysystem="<?=$paysystem_check?>">Далее</div>
                    </div>
                </div>
                <?//способ доставки END?>
...
<!--                                <div class="paysystem_item inactive_paysystem" data-paysystem="--><?//=$key?><!--" id="delivery_id_--><?//=$key?><!--">-->
<!--                                    <div class="check_paysystem_item inactive_paysystem"><div class="check_elem_paysystem --><?//if($key == 1) {echo 'paysystem_check_elem_active'; $cheked =$key;}?><!--"></div></div>-->
...
<!--                            --><?//}?>
                        ...
                        <div class="paysystem_confirm basket_btn btn_right" data-paysystem="">Оформить</div>
                    </div>
                </div>
                <?//способ оплаты END?>
                        ...
                        <div class="credit_line_box">
                            <div class="credit_line_header">
                                <div class="cl_wrap">
                                    ...
                                    <input type="text" class="header_input cl_summ_total" data-name="cl_summ_total" disabled value="<?=$arResult['ORDER_PRICE']?>">
                                </div>
                                <div class="cl_wrap">
                                    <div class="input_title">Ежемесячный платеж</div>
                                    <input type="text" class="header_input cl_summ_in_month" data-name="cl_summ_in_month" disabled value="<?=ceil($arResult['ORDER_PRICE']/12)?>">
                                </div>
                            </div>
                            <div class="credit_line_range_block">
                                <div class="cl_range_wrap">
                                    <div class="range_title">Срок рассрочки</div>
                                    <input id="cl_pay_month" class="cl_pay_month cl_range" type="range" min="1" step="1" max="12" value="12" data-name="cl_pay_month" data-text="12 мес.">
                                    <div class="range_end"><div class="range_end_count">12</div> мес.</div>
                                </div>
                                <div class="cl_range_wrap">
                                    <div class="range_title">Первоначальный платеж</div>
                                    <input id="cl_pay_first" class="cl_pay_first cl_range" type="range" min="0" step="10" max="50" value="0" data-name="cl_pay_first" data-text="%">
                                    <div class="range_end"><div class="range_end_count">0</div>%</div>
                                </div>
                            </div>
                            <div class="credit_line_info_block">
                                <div class="info_wrap wrap_100">
                                    <div class="info_title">ФИО <span class="red_star">*</span></div>
                                    <input type="text" id="cl_name" class="cl_info_input cl_name validate_input" data-name="fullname" value="<?=$_COOKIE['basket_fullname']?>">
                                </div>
                                <div class="info_wrap wrap_50">
                                    <div class="info_title">Телефон контактный <span class="red_star">*</span></div>
                                    <input type="text" id="cl_main_phone" class="cl_info_input cl_main_phone validate_input" data-name="phone" value="<?=$_COOKIE['basket_phone']?>">
                                </div>
                                <div class="info_wrap wrap_50">
                                    <div class="info_title">E-mail <span class="red_star">*</span></div>
                                    <input type="text" id="cl_mail" class="cl_info_input cl_mail validate_input" data-name="email" value="<?=$_COOKIE['basket_email']?>">
                                </div>
                                <div class="info_wrap wrap_50">
                                    <div class="info_title">Телефон доп.</div>
                                    <input type="text" id="cl_phone_dop" class="cl_info_input cl_phone_dop" data-name="phone_dop" value="<?=$_COOKIE['basket_phone_dop']?>">
                                </div>
                                <div class="info_wrap wrap_50">
                                    <div class="info_title title_checkbox">Мне исполнилось 18 лет <span class="red_star">*</span></div>
                                    <input type="checkbox" class="cl_age18 validate_input cl_checkbox alert_element" data-name="age18">
                                </div>
                                <div class="info_wrap wrap_100">
                                    <div class="info_title">Адрес <span class="red_star">*</span></div>
                                    <input type="text" id="cl_adress" class="cl_info_input cl_adress validate_input" data-name="adress" value="<?=$_COOKIE['basket_adress']?>">
                                </div>
                                <div class="info_wrap wrap_100">
                                    <div class="info_title title_checkbox">Я даю согласие на обработку моих персональных данных <span class="red_star">*</span></div>
                                    <input type="checkbox" class="cl_politics validate_input cl_checkbox" data-name="politics">
                                </div>
                            </div>
                            <script>
                                $('#cl_name').suggestions({
                            ...
                            <div class="confirm_cl_btn basket_btn btn_right orange_title">Отправить заявку</div>
            ...
            <div id="paycheck_slider" class="owl-carousel owl-theme">
                ...
                <div class="paycheck_product_box owlElement">
                    <div class="check_left_half">
                        <div class="product_box_header">
                            <div class="product_box_left paycheck_box_left">
                                ...
                                <div class="product_count paycheck_box_description"><?=$arResult["count_poducts"]?> шт.</div>
                            </div>
                    ...
                    <div class="check_right_half">
                        ...
                        <?} else {?>
                            <div class="paycheck_btn credit_line_disable" data-toggle="tooltip" data-html="true">Оформить в рассрочку</div>
                        <?}?>
                        <div class="personal_data text_block">
                            Нажимая на кнопку, вы подтверждаете своё совершеннолетие, соглашаетесь на обработку персональных данных в соответствии с
                ...
                <div class="paycheck_product_box owlElement">
                    ...
                    <?if(!empty($arResult['summary_profit'])){?>
                        <div class="paycheck_discount_box">
                            ...
                            <div class="paycheck_discount_count paycheck_box_count order_discount_price" data-price="<?=ceil($arResult["summary_profit"])?>">
                                <?=number_format(ceil($arResult["summary_profit"]), 0, '', ' ')?> руб.
                            </div>
                        </div>
                    <?}?>
                    <div class="paycheck_delivery_block">
                        ...
                        <div class="paycheck_delivery_count paycheck_box_count order_delivery_price" data-price="<?=ceil($arResult["DELIVERY_PRICE"])?>">
                    ...
                    <div class="paycheck_summary_block">
                        <div class="paycheck_summary_title">Итого</div>
                        <div class="paycheck_summary_count order_summary_price" data-price="<?=ceil($arResult["ORDER_PRICE"])?>">
                            <?=number_format(ceil($arResult["ORDER_PRICE"]), 0, '', ' ')?> руб.
                        </div>
                    </div>
                    <div class="personal_data text_block">
...
<? $APPLICATION->AddHeadScript("/bitrix/components/mainpage/basket2/script.js"); ?>
